...
kubectl kustomize "github.com/kubernetes-sigs/gateway-api/config/crd?ref=v1.2.1" -o charts/crds/
...
- [[provider_kubernetes]] <<provider_kubernetes,kubernetes>> (2.38.0)

- [[provider_utils]] <<provider_utils,utils>> (2.6.0)
...
- https://registry.terraform.io/providers/hashicorp/kubernetes/latest/docs/resources/secret_v1[kubernetes_secret_v1.grafana_admin] (resource)
- https://registry.terraform.io/providers/hashicorp/null/latest/docs/resources/resource[null_resource.dependencies] (resource)
- https://registry.terraform.io/providers/hashicorp/null/latest/docs/resources/resource[null_resource.this] (resource)
- https://registry.terraform.io/providers/hashicorp/kubernetes/latest/docs/data-sources/secret_v1[kubernetes_secret_v1.grafana_admin] (data source)
...
|`string`
|`"https://github.com/GersonRS/modern-gitops-stack-module-kiali.git"`
|no
...
|[[input_base_domain]] <<input_base_domain,base_domain>>
|Base domain of the cluster. Value used for the Gateway hostname wildcard. If empty, '*' is used as the hostname.
|`string`
|`""`
|no
